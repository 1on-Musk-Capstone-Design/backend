...
public class WebSocketService {
  ...
  private ChatMessageService chatMessageService() {
    ChatMessageService chatMessageService = chatMessageServiceProvider.getIfAvailable();
    if (chatMessageService == null) {
      throw new IllegalStateException("ChatMessageService is only available in chat-service");
    }
