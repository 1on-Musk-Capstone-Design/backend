...
- EC2 instance public IP: `100.55.36.73`
- Spring backend and SFU on the same EC2 host: use `http://127.0.0.1:4000` between them
- Browser clients connect to SFU/TURN through `100.55.36.73`
...
```env
VITE_WEBRTC_TURN_URLS=turn:100.55.36.73:3478?transport=udp,turn:100.55.36.73:3478?transport=tcp
