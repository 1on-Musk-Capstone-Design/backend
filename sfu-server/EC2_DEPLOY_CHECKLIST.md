...
- EC2 instance public IP: `43.201.225.38`
- Spring backend and SFU on the same EC2 host: use `http://127.0.0.1:4000` between them
- Browser clients connect to SFU/TURN through `43.201.225.38`
...
SFU_ANNOUNCED_IP=43.201.225.38
...
```env
VITE_WEBRTC_TURN_URLS=turn:43.201.225.38:3478?transport=udp,turn:43.201.225.38:3478?transport=tcp
