...
- EC2 instance public IP: `54.91.162.220`
- Spring backend and SFU on the same EC2 host: use `http://127.0.0.1:4000` between them
- Browser clients connect to SFU/TURN through `54.91.162.220`
...
SFU_ANNOUNCED_IP=54.91.162.220
...
```env
VITE_WEBRTC_TURN_URLS=turn:54.91.162.220:3478?transport=udp,turn:54.91.162.220:3478?transport=tcp
