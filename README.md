...
| voice-service | 8085 | voice_session, voice_session_user, WebRTC SFU control API |
...
| sfu-server | 4000 | mediasoup 기반 음성 채팅 SFU |
...
| `/api/v1/webrtc/sfu/**` | voice-service |
...
APP_WEBRTC_SIGNAL_AUTH_SOFT_VALIDATION_ENABLED=false
APP_WEBRTC_SIGNAL_TOPIC_PREFIX=/topic/workspace
APP_WEBRTC_VOICE_SESSION_SEGMENT=voice
APP_WEBRTC_SIGNAL_SEGMENT=signal
APP_WEBRTC_SFU_SERVER_BASE_URL=http://sfu-server:4000
APP_WEBRTC_SFU_SERVER_HTTP_PORT=4000
APP_WEBRTC_SFU_SERVER_HEALTH_PATH=/health
APP_WEBRTC_SFU_SERVER_ROOMS_PATH=/rooms
APP_WEBRTC_SFU_SERVER_WS_PATH=/ws
APP_WEBRTC_SFU_WORKER_MIN_PORT=40000
APP_WEBRTC_SFU_WORKER_MAX_PORT=40100
APP_WEBRTC_SFU_LOG_LEVEL=warn
...
#### WebRTC SFU API
- `GET /api/v1/webrtc/sfu/health`
- `GET /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/router-capabilities`
- `POST /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/transports`
- `POST /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/transports/{transportId}/connect`
- `POST /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/producers`
- `GET /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/producers`
- `POST /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/consumers`
- `POST /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/consumers/{consumerId}/resume`
- `DELETE /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}/peers/{peerId}`
- `DELETE /api/v1/webrtc/sfu/workspaces/{workspaceId}/sessions/{sessionId}`
...
- `/app/webrtc/signal` - WebRTC offer/answer/ICE/SFU signaling relay
...
- `/topic/workspace/{workspaceId}/voice/{sessionId}/signal` - WebRTC signaling 수신
...
- [x] mediasoup SFU 서버 추가
- [x] WebRTC signaling STOMP relay 추가
- [x] SFU control API를 voice-service로 분리
